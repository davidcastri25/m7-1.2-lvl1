...
CREAR_COHETE_1.addEventListener("click", (e: Event) => {
    //Datos del cohete a crear
    let codigo: string = "32WESSDS";
    let propulsores: number[] = [10, 30, 80];
...
CREAR_COHETE_2.addEventListener("click", (e: Event) => {
    //Datos del cohete a crear
    let codigo: string = "LDSFJA32";
    let propulsores: number[] = [30, 40, 50, 50, 30, 10];
...
ACELERAR_COHETE_1.addEventListener("click", (e: Event) => {
...
ACELERAR_COHETE_2.addEventListener("click", (e: Event) => {
    //Llamamos a la función de acelerar cohete
...
FRENAR_COHETE_1.addEventListener("click", (e: Event) => {
    frenarCohete("32WESSDS");
});


/* ////////// Evento botón frenar cohete 2 ////////// */
FRENAR_COHETE_2.addEventListener("click", (e: Event) => {
    frenarCohete("LDSFJA32");
});


/* ////////// Evento botón imprimir cohete 1 ////////// */
IMPRIMIR_COHETE_1.addEventListener("click", (e: Event) => {
    let index: number;
...
IMPRIMIR_COHETE_2.addEventListener("click", (e: Event) => {
    let index: number;
...
IMPRIMIR_ALL_COHETES.addEventListener("click", (e: Event) => {
